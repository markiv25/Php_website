        ...
        <?php  foreach ($data as $i){
            ...
            <tr><form method='POST'>
              ...
              <td><input type='text' name='name' value='$i[1]'></td>
                      <td><input type='text' name='num' value='$i[2]'></td>
                      <td><input type='text' name='event_id' value='$i[3]'></td>
                      <td><input type='text' name='srt' value='$i[4]'></td>
                      <td><input type='text' name='end' value='$i[5]'></td>
